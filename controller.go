...
import (
    ...
    // 这些就是自动生成的代码
    bolingcavalryv1 "github.com/mingregister/crd-learn/pkg/apis/bolingcavalry/v1"
    clientset "github.com/mingregister/crd-learn/pkg/client/clientset/versioned"
    studentscheme "github.com/mingregister/crd-learn/pkg/client/clientset/versioned/scheme"
    informers "github.com/mingregister/crd-learn/pkg/client/informers/externalversions/bolingcavalry/v1"
    listers "github.com/mingregister/crd-learn/pkg/client/listers/bolingcavalry/v1"
)
...
// 创建controller的NewController方法中，定义了收到Student对象的增删改消息时的具体处理逻辑，除了同步本地缓存，就是将该对象的key放入消息中；
...
// 实际处理消息的方法是syncHandler，这里面可以添加实际的业务代码，来响应Student对象的增删改情况，达到业务目的；
// 处理
